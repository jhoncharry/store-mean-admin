  ...
  !(function (t) {
    var e = {
      ...
      passwordVisibilityToggle: function () {
        for (
          var r = document.querySelectorAll(".cs-password-toggle"), e = 0;
          e < r.length;
          e++
        )
          !(function (e) {
            var t = r[e].querySelector(".form-control");
            r[e].querySelector(".cs-password-toggle-btn").addEventListener(
              "click",
              function (e) {
      ...
      fileDropArea: function () {
        for (
          var t = document.querySelectorAll(".cs-file-drop-area"), e = 0;
          e < t.length;
          e++
        )
          !(function (e) {
                  ...
                  (((e = new FileReader()).onload = function (e) {
                    ...
                    (a.innerHTML = r),
                      e.startsWith("data:image")
                        ? (((t = new Image()).src = e),
                          (t.onload = function () {
                            (o.className = "cs-file-drop-preview"),
                              (o.innerHTML =
                        ...
                        ? ((o.innerHTML = ""),
                          (o.className = ""),
                          (o.className = "cs-file-drop-icon cxi-video"))
                        : ((o.innerHTML = ""),
                          (o.className = ""),
                          (o.className = "cs-file-drop-icon cxi-files"));
                  }),
        ...
        for (
          var i = function () {
              ...
              if (
                ...
                o && ((n.style.paddingRight = 0), a.length))
              )
                for (var t = 0; t < a.length; t++)
                  a[t].classList.remove("right-15");
            ...
            e.preventDefault(),
              (function (e) {
                if (
                  ...
                  o && ((n.style.paddingRight = "15px"), a.length))
                )
                  for (var t = 0; t < a.length; t++)
                    a[t].classList.add("right-15");
      ...
      scrollTopButton: function () {
        var t,
          r = document.querySelector(".btn-scroll-top");
        null != r &&
          ((t = parseInt(600, 10)),
          window.addEventListener("scroll", function (e) {
            e.currentTarget.pageYOffset > t
      ...
      rangeSlider: function () {
        for (
          var a = document.querySelectorAll(".cs-range-slider"), e = 0;
          e < a.length;
          e++
        )
          !(function (e) {
      ...
      filterList: function () {
        for (
          var t = document.querySelectorAll(".cs-filter"), e = 0;
          e < t.length;
          e++
        )
          (function (e) {
            var r = t[e].querySelector(".cs-filter-search"),
              n = t[e]
                .querySelector(".cs-filter-list")
                .querySelectorAll(".cs-filter-item");
            if (!r) return;
            r.addEventListener("keyup", function () {
              for (var e = r.value.toLowerCase(), t = 0; t < n.length; t++)
                -1 <
                n[t]
                  .querySelector(".cs-filter-item-text")
              ...
              delete window[i],
                ...
                "success" == e.result
                  ? (r.classList.remove("is-invalid"),
                    ...
                    a.classList.remove("cs-status-error"),
                    a.classList.add("cs-status-success"),
                    (a.innerHTML = e.msg),
                    setTimeout(function () {
                      r.classList.remove("is-valid"),
                        (a.innerHTML = ""),
                        a.classList.remove("cs-status-success");
                    }, 6e3))
                  : (r.classList.remove("is-valid"),
                    r.classList.add("is-invalid"),
                    a.classList.remove("cs-status-success"),
                    a.classList.add("cs-status-error"),
      ...
      bindedContent: function () {
        for (
          var e = document.querySelectorAll("[data-binded-content]"),
            t = (document.querySelector(".cs-binded-content"), 0);
          t < e.length;
          t++
        )
        ...
        var r = function (e) {
          for (
            var e = document.querySelector(e),
              t = e.parentNode.querySelectorAll(".cs-view"),
              r = 0;
            r < t.length;
            r++
          )
      ...
      filtersShowHide: function () {
        ...
        null !== n &&
          (r.addEventListener("click", function (e) {
            ...
            r.classList.remove("d-lg-block"),
              t.classList.remove("d-lg-none"),
          ...
          t.addEventListener("click", function (e) {
            ...
            r.classList.add("d-lg-block"),
              t.classList.add("d-lg-none"),
